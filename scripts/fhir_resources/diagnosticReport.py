...
from scripts.enum_models import ImagingType, PerforationProcedures, PostNeurosurgeryImaging, PostRecanalizationImaging, SpecificFinding
...
def build_ct_mr_after_ivt_diagnostic_report(patient_ref: str, encounter_ref: str, observation_ref: list, imaging_type :PostNeurosurgeryImaging | PostRecanalizationImaging ) -> DiagnosticReport:
    ...
    Args:
        patient_ref: Reference to the Patient resource
        encounter_ref: Reference to the Encounter resource
        ct_mr_after_ivt_results: CT/MR after IVT result as ImagingType enum value
    Returns:
...
def build_follow_up_ct_mr_diagnostic_report(patient_ref: str, encounter_ref: str, bleeding_volume_follow_up_ref: str, imaging_performed: ImagingType, hydrocephalus: bool) -> DiagnosticReport:
    """
