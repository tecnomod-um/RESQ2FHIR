...
from scripts.enum_models import AssessmentContext, ConceptEnum, DischargeMedication, Medications, NotMedicationReason, PostAcuteCare, UnitofMeasurement
...
def build_medicationAdministration(patient_ref:str, encounter_ref:str, medication: Medications, condition_ref: str | None = None, procedure_ref:str | None = None, observation_ref: str | None = None, dose: int | None = None, medication_post_acute: bool | None = None, medication_timestamp: str | None = None, medication_range_timing: str | None = None, no_medication_reason: NotMedicationReason | None = None) -> MedicationAdministration:
    """
    Build a FHIR MedicationAdministration resource.
    
    Args:
        medication: The medication administered
        medication_timing: The timing of the medication administration in boolean (True for post-acute care, False for acute care, None for unknown)
        patient_ref: Reference to the Patient resource
        encounter_ref: Reference to the Encounter resource
...
def build_paracetamol_on_fever(patient_ref:str, encounter_ref:str, fever_ref:str):
    """
...
def build_no_anticoagulant_reversal_medicationAdministration(patient_ref:str, encounter_ref:str, no_anticoagulant_reversal_reason:ConceptEnum) -> MedicationAdministration:
    """
...
def build_insulin_on_hyperglycemia(patient_ref:str, encounter_ref:str, insulin_timing: AssessmentContext) -> MedicationAdministration:
    """
...
def build_no_anticoagulant_discharge_medicationAdministration(patient_ref:str, encounter_ref:str, no_anticoagulant_discharge_reason:ConceptEnum) -> MedicationAdministration:
    """
